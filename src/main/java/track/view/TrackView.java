...
public class TrackView extends JDialog implements Observer, View {
    ...
    public int getMinValue() {
        int minValue = -1;
        try {
            minValue = Integer.parseInt(fieldMin.getText());
    ...
    public int getMaxValue() {
        int maxValue = -1;
        try {
            maxValue = Integer.parseInt(fieldMin.getText());
        } catch (NumberFormatException e) {
            e.getStackTrace();
            displayNotIntError();
        }
    ...
    private void $$$setupUI$$$() {
        ...
        fieldMin = new JFormattedTextField();
        fieldMin.setText("");
        ...
        fieldMax = new JFormattedTextField();
